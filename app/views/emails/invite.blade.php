...
@section('content')
	...
	<p>If you're between projects, it's a great place to find small-scale tasks to experiment with new skills. To get started, log in with your IDEO e-mail credentials, and Halp will notify you whenever a new task is created.</p>
